 ...
 * 
 * @author gao
 * @Time 2012-10-10下午08:25:22
 */
public class SysConfigurationReadUtil {

	/**
	 * 属性文件全名,需要的时候请重新配置PFILE
	 */
	private static String PFILE = "SysConfiguration.properties";
	 ...
	 * 唯一实例
	 */
	private static SysConfigurationReadUtil m_instance = new SysConfigurationReadUtil();
	 ...
	 */
	private SysConfigurationReadUtil() {
		try {
	 ...
	 */
	public synchronized static SysConfigurationReadUtil getInstance() {
		return m_instance;
	}
