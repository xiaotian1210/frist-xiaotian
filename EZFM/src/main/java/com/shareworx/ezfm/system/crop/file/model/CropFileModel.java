 ...
 */
package com.shareworx.ezfm.system.crop.file.model;
...
public class CropFileModel extends DomainModel {
	
	/**
	 * 元数据名称
	 */
	public final static String META_ID = "yjwy_pub_crop_file";
