...
function initAreaProject(areaId, projectId, userId) {
	...
	$("#" + projectId).combobox({
		onSelect: function(rec) {
			var url = 'ezfm/worktask/performance/queryUser?pk_project=' + rec.pk_project;
			queryData(userId, url, "pk_user", "user_name");
		}
	});
	//初始化维修人员列表
	queryData(userId, "ezfm/worktask/performance/queryUser", "pk_user", "user_name");
...
function querySubmit() {
	...
	$("#datagrid_performance").datagrid("load", {
		pk_area: pk_area,
