...
(function ($) {
    ...
    $.fn.treegrid = function (_c4, _c5) {
        ...
        return this.each(function () {
            ...
            if (_c7) {
                ...
                _c7 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _c4),
                    data: [],
                    checkedRows: [],
                    tmpIds: []
                });
    ...
    $.fn.treegrid.parseOptions = function (_dc) {
        return $.extend({}, $.fn.datagrid.parseOptions(_dc), $.parser.parseOptions(_dc, ["treeField", {
            checkbox: "boolean",
