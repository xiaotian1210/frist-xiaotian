...
public abstract class UmengNotification {
    ...
    //以下自定义需要多加的参数
  	public void setPmModule(String module) throws Exception {
  		setPredefinedKeyValue("pm_module", module);
  	}
  	public void setPmFunction(String function) throws Exception {
  		setPredefinedKeyValue("pm_function", function);
  	}
  	public void setPmExt(Map<String,Object> extMap) throws Exception {
  		setPredefinedKeyValue("pm_ext", extMap);
  	}
